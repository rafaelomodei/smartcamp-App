      ...
      body: ListView(
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                Button('Todos os campos', color: Colors.blue),
                Button('Campo 1', color: Colors.blue),
                Button('Campo 2', color: Colors.blue),
                Button('Campo 3', color: Colors.blue),
                Button('Campo 4', color: Colors.blue),
                Button('Campo 5', color: Colors.blue),
                Button('Campo 6', color: Colors.blue),
              ],
            ),
          ),
          ListView.separated(
